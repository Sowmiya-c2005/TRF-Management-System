...
# Default test users with passwords
TEST_USERS = [
    {
        "username": "admin",
        "email": "admin@trf.com",
...
def create_test_users():
    ...
    try:
        ...
        for user in TEST_USERS:
            print(f"  Username: {user['username']:<12} | Password: {user['password']:<15} | Role: {user['role']}")
        print("-" * 60)
